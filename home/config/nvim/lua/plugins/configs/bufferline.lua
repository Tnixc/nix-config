...
local t = require("theme.colors")
bl.setup({
    -- highlights = require("evergarden.special.bufferline").get_theme({
    --     styles = { "bold" },
    --     custom = {
    --         macchiato = {
    --             fill = { bg = t.mantle },
    ...
    --             separator_visible = { fg = t.mantle, bg = t.surface1 },
    --             buffer_selected = { bg = t.surface1 },
    --             buffer_visible = { bg = t.surface1, fg = t.subtext1 },
    --             close_button = { bg = t.base },
    --             close_button_selected = { bg = t.surface1 },
    --             close_button_visible = { bg = t.surface1, fg = t.subtext0 },
    --             modified = { bg = t.base },
    --             modified_selected = { bg = t.surface1 },
    --             modified_visible = { bg = t.surface1 },
    --             duplicate_selected = { bg = t.surface1 },
    --             duplicate_visible = { bg = t.surface1 },
